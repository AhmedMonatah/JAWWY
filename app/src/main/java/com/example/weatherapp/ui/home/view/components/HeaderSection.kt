    ...
    Row(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Surface(
                modifier = Modifier.size(40.dp),
                shape = CircleShape,
                color = com.example.weatherapp.ui.theme.RamadanGold.copy(alpha = 0.2f)
            ) {
                Icon(Icons.Default.LocationOn, null, Modifier.padding(8.dp), com.example.weatherapp.ui.theme.RamadanGold)
            }
