...
class LocalDataSourceImpl(
    ...
    override fun getHourlyForecast(): Flow<List<HourlyForecastEntity>> =
        weatherDao.getHourlyForecast()

    override suspend fun insertHourlyForecast(hourly: List<HourlyForecastEntity>) =
        weatherDao.insertHourlyForecast(hourly)

    override suspend fun clearHourlyForecast() =
        weatherDao.clearHourlyForecast()
    ...
    override suspend fun getFavoriteByCoords(lat: Double, lon: Double): FavoriteLocation? =
        favoriteDao.getFavoriteByCoords(lat, lon)
